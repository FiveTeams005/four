...
function Package_MyBuy(img,title,price,status) {
    ...
    this.Ocontainer=$('<div class="container">' +
        ...
        '</div> </div> <div class="row" style="border-top: 1px solid #ccc"><div class="col-xs-4 text-left" style="line-height: 30px"><img src="../../public/home/img/xianyu/comment_small.png">联系卖家</div> ' +
