...
<title>后台登陆</title>
    <link href="/four/Public/admin/css/style_log.css" rel="stylesheet" type="text/css">
    <script src="/four/Public/static/jquery/jquery.min.js"></script>
</head>

<body class="login" mycollectionplug="bind">
<div class="login_m">
<div class="login_logo"><img src="/four/Public/admin/img/login/logo.png" width="196" height="46"></div>
...
<div class="login_padding" id="login_model">
  ...
  <label>
    ...
    <p style="float: left;margin-top: 10px">Verification Code:</p><input id="codeIpt" type="text" >
    <div id="code"><img id="img" src="/four/Public/admin/img/login/login/yzm.png" alt=""></div>
  <div class="rem_sub">
  <div class="rem_sub_l">
  <input type="checkbox" name="checkbox" id="save_me">
   <label for="checkbox">Remember me</label>
    ...
    <label>
      <input type="button" class="sub_button" name="button" id="button" value="SIGN-IN" style="opacity: 0.7;">
    </label>
  </div>
</div>
...
<script src="/four/Public/admin/js/login.js"></script>
</body>
</html>