...
<head>
    ...
    <link rel="stylesheet" href="/four/Public/home/css/publish/publishStyle.css">
...
<body class="bg">
   ...
   <div class="container con-form">
           ...
           <div class="form-group">
               <div class="row">
                   ...
                   <div class="col-xs-3 text-center describe-img">
                       <img src="/four/Public/home/img/images/a.jpg" class="logo1">
                       <img src="/four/Public/home/img/xianyu/select_photo_cancel.png" class="close-logo">
                   </div>
                   <div class="col-xs-3 text-center describe-img">
                       <img src="/four/Public/home/img/images/b.jpg" class="logo1">
                       <img src="/four/Public/home/img/xianyu/select_photo_cancel.png" class="close-logo">
                   </div>
                   </div>
                   <div class="col-xs-3 text-center insert-img">
                       <img src="/four/Public/home/img/images/add.png" class="logo1">
                   </div>
               </div>
           </div>
           <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="row row-underline">
                    <div class="col-xs-4 col-xs-offset-4 text-center">
                        <div class="form-group">
                        <input type="number" class="form-control goods-price" placeholder="￥0.00">
                        </div>
                    </div>
                </div>
                <div class="row text-left main">
                    <div class="col-xs-3"><span class="text1">分类</span></div>
                    <div class="col-xs-9 text">
                        <div class="col-xs-8 col-xs-offset-2 text-right text1"><span class="text1">请选择分类</span></div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <button type="button" class="btn btn-red">确认发布</button>
                </div>
            </div>
        </div>
    </form>
