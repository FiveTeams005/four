                        ...
                        <form method="post" action=" ">
                            <div class="umar-a uba bc-border c-wh">
                                ...
                                <div class="ub ub-ac umh5 bc-border">
                                    <div class="uinput ub ub-f1">
                                        <div class="uinn fa  sc-text">
                                            <img src="/Public/Home/img/images/login_code_1.png" style="max-height: 17px;">
                                        </div>
                                        <input placeholder="验证码" type="text" name="code" class="ub-f1">
                                        <div id="code-box">
                                            <img src="<?php echo U('Home/Test/code');?>" alt='验证码' id="code" />
                                        </div>
                                    </div>
                                </div>
                            </div>
